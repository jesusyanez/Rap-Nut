...
<footer className="footer px-10 py-4 border-t bg-base-200 bg-[url('../public/block1.png')] bg-center text-base-content border-base-300">
  <div className="items-center grid-flow-col">
    ...
    <p>Loophole.gg <br />Playing beats since 2022</p>
  </div> 
